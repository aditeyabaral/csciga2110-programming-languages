...
;; which updates the conetns of a box and seqC which corresponds to
;; Racket's (begin e1 e2) form. Here we have the extended Expr type and the parser but nothing else.
